...
//    static DistanceMethod BEACON_DISTANCE_METHOD;   //! The preferred method for calculating the distance to the beacons
    ...
    static float BALL_MIN_PERCENT_ORANGE;   //! 
    static float GOAL_MIN_PERCENT_YELLOW;   //! 
    static float GOAL_MIN_PERCENT_BLUE;     //! 
    static int MIN_GOAL_SEPARATION;

    //! Obstacle detection constants
    static int MIN_DISTANCE_FROM_HORIZON;   //! 
    static int MIN_CONSECUTIVE_POINTS;      //! 
